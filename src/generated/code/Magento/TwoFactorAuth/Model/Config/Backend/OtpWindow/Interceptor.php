<?php
namespace Magento\TwoFactorAuth\Model\Config\Backend\OtpWindow;

/**
 * Interceptor class for @see \Magento\TwoFactorAuth\Model\Config\Backend\OtpWindow
 */
class Interceptor extends \Magento\TwoFactorAuth\Model\Config\Backend\OtpWindow implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function processValue($value)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('processValue', func_get_args(), $pluginInfo) : parent::processValue($value);
    }
